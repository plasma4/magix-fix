...
var magix2Link = magixURL2 + 'magix2.png?v=4.0' //Version 4.0: made by @fractylizer on Discord
G.AddData({
    name: 'MagixUtils',
    author: 'pelletsstarPL',
    desc: 'Some mechanics that are in Magix code are contained within this mod. Required to play Magix.',
    engineVersion: 1,
    sheets: { "magixmod": magixURL2 + 'magixmod.png', 'magix2': magix2Link, 'seasonal': magixURL + 'seasonalMagix.png', "c2": magixURL2 + 'CiV2IconSheet.png' },//just for achievs
    func: function () {
        ...
        G.tabPopup['Magix'] = function () {
            ...
            str += '<div class="par">' +
                ...
                '<br>(Various improvements and fixes have been added at @1_e0, a programmer. You can find me in the <a href="https://discord.gg/cookie" target="_blank">Dashnet discord server</a>.)<br><b>Sprite designs were created by Orteil (base game sprites), @pelletsstarPL (base Magix sprites), @fractylizer (much improved new Magix sprites), @1_e0 (original new Magix sprites), and @theskullyko (a few misc sprites) and merged together.</b>' +
        ...
        G.policyCategories.push(
            ...
            { id: 'spell', name: '<font color="#398fe6">Spells</font>' },
        ...
        G.update['tech'] = function () {
            ...
            str +=
                ...
                (isC1 ? '<div id="techUI" class="bottomUI bgPanelUp" style="background-image: url(\'img/darkEdgeBorders.png\'),url(\'' + (isUsingFile ? magixURL : magixURL + Theme + 'Theme/') + 'bgUpRock' + Theme + '.jpg\')">'
            ...
            */
            ...
            for (var i = 0; i < len; i++) {
                ...
                if (G.unitByName[G.unitsOwned[i].unit.name].visible == true) {
                    ...
                    if (me.unit.gizmos) {
                        var div = l('unit-mode-' + me.id);
                        if (div) div.onmousedown = function (unit, div) { return function () { G.selectModeForUnit(unit, div); }; }(me, div);
                        if (div) G.addTooltip(div, function (me, instance) { return function () { return 'Click or drag to change unit mode.<br>Current mode:<div class="info"><div class="fancyText barred infoTitle">' + (instance.mode.icon ? G.getSmallThing(instance.mode) : '') + '' + instance.mode.name + '</div>' + G.parse(instance.mode.desc) + '</div>'; }; }(me.unit, me), { offY: -8 });
                        var div = l('unit-split-' + me.id);
                        if (div) div.onclick = function (unit, div) { return function () { if (G.speed > 0) G.splitUnit(unit, div); else G.cantWhenPaused(); }; }(me, div);
                        if (div) G.addTooltip(div, function (me, instance) { return function () { if (instance.splitOf) return 'Click to <u>remove</u> this stack of units.'; else return 'Click to <u>split</u> into another unit stack.<br>Different unit stacks can use different modes.' }; }(me.unit, me), { offY: -8 - 16 });
                        var div = l('unit-percent-' + me.id);
                        if (div) div.onmousedown = function (unit, div) { return function () { if (G.speed > 0) G.selectPercentForUnit(unit, div); else G.cantWhenPaused(); }; }(me, div);
                        if (div) G.addTooltip(div, function (me, instance) { return function () { return 'Click or drag to set unit work capacity.<br>Well, actually, this feature isn\'t implemented yet.' }; }(me.unit, me), { offY: 8, anchor: 'bottom' });
                    }
    ...
    =======================================================================================*/
        ...
        new G.Achiev({
            ...
            desc: 'You sacrificed your soul for the Dreamer\'s Orb. That choice was unexpected but glorious. It made dreamers more acknowledged and people got much smarter by your sacrifice. They will miss you, but this made a profit...providing <b><font color="#b5bbfd">+6 insight and +6% dreamer speed</font></b> at the start of new runs!',
        ...
        new G.Achiev({
            ...
            icon: [10, 22, "magixmod"],
            desc: 'Construct the Fortress of Magicians, a very [magic essences,Magical] wonder! //This achievement will: @unlock a new theme @increase the effect of <b>Wizard towers</b> by 5% without increasing their upkeep cost @unlock advanced technologies related to [hunter]s, [fisher]s, and [grave]s',
            effects: [
                { type: 'addFastTicksOnStart', amount: 150 },
                { type: 'addFastTicksOnResearch', amount: 15 },
            ],
        ...
        new G.Achiev({
            ...
            icon: [23, 21, "magixmod"],
            name: 'apprentice',
            desc: 'Get 100 or more technologies in a single legacy for the human race.//<small>Cool!</small>',
            civ: 0,
            plural: false
        });
        new G.Achiev({
        ...
        new G.Achiev({
            ...
            icon: [32, 26, "magixmod"],
            desc: 'Obtain 2 traits that will lower your [faith] gain and choose a Seraphin that decreases [faith] gain as well. To make this achievement possible, <b><font color="#f66">Devil\'s trait #13</font></b> is not required.',
            effects: [
        ...
        new G.Achiev({
            ...
            name: 'it\'s over 9000',
            icon: [35, 10, "magixmod"],
            desc: 'What?! NINE THOUSAND?! There is no way that can be right.',
            effects: [
            ],
            visible: false,
            civ: "overall",
        ...
        new G.Achiev({
            ...
            desc: 'Push <b>Pressure</b> enough to be capable of having 25k [population,Elves]. //<small>You know that pressure also affects your production efficiency. But...do you even care?</small>',
            icon: [32, 10, "c2"],
            effects: [
        ...
        new G.Achiev({
            tier: 'population',
            name: 'pressure wiper',
            desc: 'Push <b>Pressure</b> enough to be capable of having 175k [population,Elves]. //<small>Ingwe would be jealous.</small>',
            icon: [32, 12, "c2"],
            effects: [
        ...
        new G.Achiev({
            ...
            desc: 'Push <b>Pressure</b> enough to be capable of having 300k [population,Elves]. //<small>Elves are terrific. They beget terror.</small>',
            icon: [32, 13, "c2"],
            effects: [
        ...
        new G.Achiev({
            ...
            tier: 'tech',
            name: 'familiar',
            desc: 'Get 200 or more technologies in a single run for the human race. //<small>There sure is a lot to know...</small>',
            civ: 0,
            plural: false
        });
        ...
        new G.Achiev({
            ...
            icon: [13, 33, "magixmod"],
            name: 'A+ student',
            desc: 'Get 250 or more technologies in a single run for the human race. //<small>Our people sure are genius...</small>',
            civ: 0,
            plural: false
        });
        new G.Achiev({
        ...
        // juuuuuuuuuuuuust for fun!
        new G.Achiev({
            tier: 0,
            name: 'seraphin complex',
            icon: [32, 8, "magixmod"],
            desc: 'Declare yourself as a helper and get sued.',
            effects: [
            ],
            visible: false,
            civ: "overall",
        ...
        G.canoeRaftEffect = function (amount, tileName) {
            ...
            if (G.techsOwnedObject['rafts'] && G.has('rafts')) {
            ...
            if (G.has('tile inspection') && !G.storageObject.showMoonMap) {
                ...
                for (var ii in tile.goods) {
                    ...
                    if (!me.noAmount) {
                        ...
                        str += '<div class="icon" style="background:url(' + magixURL2 + 'magixmod.png);' + G.getFreeformIcon(816, 0 + bar * 7, 24, 6) + 'top:100%;"></div>';
                    }
                    str += '</div>';
                    I++;
                }
        ...
        G.Logic = function (forceTick) {
            ...
            if (G.modsByName['Default dataset']) {
                if (Date.now() - G.startDate <= 600000) {
                    if (techs >= 60) {
                        if (G.achievByName['speed researcher'].won == 0) G.middleText("- Completed speed researcher I<br>shadow achievement - ", 'slow');
                        G.achievByName['speed researcher'].won = 1;
                    }

                    if (techs >= 100) {
                        if (G.achievByName['speed researcher II'].won == 0) G.middleText("- Completed speed researcher II<br>shadow achievement - <br><hr width='30%' /><br><small>So speedy...</small>", 'slow');
                        G.achievByName['speed researcher II'].won = 1;
                    }
                }
            }
            if (G.modsByName['Elves']) {
                    ...
                    if ((!effect.mode || me.mode.id == effect.mode) && (!effect.notMode || me.mode.id != effect.notMode)) {
                        if (type == 0)//effects that happen every tick
                        {
                            if (!effect.every || G.tick % effect.every == 0)//.every : effect only triggers every X days
                            {
                                ...
                                for (var repI = 0; repI < repeat; repI++) {
                                    ...
                                    else if (effect.type == 'gatherFunc')//gatherFunc - added by Garchmop
                                    {
                                        if (!effect.chance || Math.random() < effect.chance) {
                                            var resWeight = 0.95;
                                            var unitWeight = 1 - resWeight;
                                            ...
                                            for (var ii in res) {
                                                var amount = 0;
                                                if (specific) {
                                                    var toGather = myAmount * res[ii](me);
                                                    var resAmount = toGather;//if no context is defined, ignore terrain goods - just harvest from thin air
                                                    if (effect.context && G.currentMap.computedPlayerRes[effect.context]) resAmount = G.currentMap.computedPlayerRes[effect.context][ii] || 0;
                                                    var max = effect.max || 0;
                                                }
                                                else {
                                                    var toGather = myAmount * (effect.amount(me) || 1);
                                                    var resAmount = res[ii];
                                                    var max = effect.max(me) || 0;
                                                }
                        ...
                        else if (type == 2)//effects that modify the effective unit amount
                        {
                            ...
                            else//flat values
                            {
                                ...
                                else if (effect.type == 'multFunc')//multiply the amount by the value (functional!) (added by Garchmop)
                                {
                                    out *= effect.func();
                                }
                            }
        ...
        G.funcs['>9000'] = function () {
            ...
            if (G.achievByName['it\'s over 9000'].won < 1) G.middleText('- Completed <font color="chocolate">It\'s over 9000</font> shadow achievement - <hr width="300"><br><small>Wow, that number is truly incredible!</small>', 'slow');
